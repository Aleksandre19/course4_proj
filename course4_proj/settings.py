...
class Dev(Configuration):
    ...
    MIDDLEWARE = [
        ...
        # 'django.middleware.csrf.CsrfViewMiddleware', # Only necessary for the Codio.
        'django.contrib.auth.middleware.AuthenticationMiddleware',
        'django.contrib.messages.middleware.MessageMiddleware',
        # 'django.middleware.clickjacking.XFrameOptionsMiddleware', # Only necessary for the Codio.
    ]
